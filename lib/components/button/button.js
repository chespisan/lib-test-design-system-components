...
var Button = function (props, ref) {
    ...
    if (as && !disabled) {
        return (_jsx(StyledButton, __assign({ as: as, to: to, ref: ref, className: className }, styles, { children: loading ? (_jsx(_Fragment, { children: "Loading" }, void 0)) : childrenWithIcon }), void 0));
    }
    if (href && !disabled) {
        return (_jsx(StyledButton, __assign({ as: 'a', href: href, ref: ref, className: className }, styles, { children: loading ? (_jsx(_Fragment, { children: "Loading" }, void 0)) : childrenWithIcon }), void 0));
    }
